...
if(isset($_GET["id"])){
	...
	$sql = "SELECT * from ewallet AS A
						left join user AS U ON U.id=A.ew_member
						where A.ew_member = '$id'
						ORDER BY A.ew_datetime DESC ";
                                    ...
                                    <tbody>
                                        <?php
											...
											while($row = $result->fetch_assoc())
											{
												...
												$v_userid =$row["ew_member"];
												$v_datetime =$row["ew_datetime"];
												$v_begining =$row["ew_cashbegining"];
												$v_add =$row["ew_cashadd"];
												$v_minus =$row["ew_cashminus"];
												$v_balance =$row["ew_cashbalance"];
												$v_description =$row["ew_description"];
