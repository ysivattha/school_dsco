		...
		<div class = "col-md-4 col-md-offset-4 col-xs-12">
			...
			<!-- <?php
			 ...
			 ?> -->
				...
				<div class = "row">
					<div class = "col-xs-12">
						<center><img src="img/success_image.png"​ class = "img-responsive"></center>
					</div>
				</div>
				<form class="form-horizontal" action = "" method = "post" data-toggle="validator" role="form">
				  ...
				  <a href="index.php" style="border-radius: 0px;" class="btn btn-danger btn-block btn-lg"><i class="fa fa-undo"></i> Back to login </a> 
				  </div>
				</form>
			</div>
        </div>
