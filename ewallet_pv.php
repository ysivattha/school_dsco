                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
							<h3 class = "text-primary"><i class="fa fa-list" aria-hidden="true"></i> Ewallet PV</h3>
							<hr>
                       </div>
							  <!-- Modal -->
                                ...
                                <table id="example" class="display nowrap" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
											...
											while($row = $result->fetch_assoc())
											{
												...
												$v_sponcer_id =$row["sponcer_id"];
                                                    ...
                                                    $v_id = @$row["id"];
                                                    $selectpid = "SELECT * from ewallet_pv
                                                                            WHERE epv_member='$v_id'
                                                                            ORDER BY epv_id DESC LIMIT 1
                                                                            ";
										...
										<tr>
                                            ...
                                            <td><?php 
                                                    echo @$rowpid['epv_cashbalance']+0;
                                            ?></td>
                                            <td>
                                                <a href="ewallet_pv_detail.php?id=<?php echo $row['id']; ?>" class="btn btn-success"> Detail</a>
