...
<div class="portlet light bordered">
    <div class="row">
        <div class="col-xs-12">
            <h2><i class="fa fa-cubes fa-fw"></i>Sale Report by Date</h2>
        </div>
    </div>
    <br>
    <div class="row">
        ...
        <div id="sample_1_wrapper" class="dataTables_wrapper">
            <table id="example" class="display nowrap" width="100%" cellspacing="0">
                ...
                <tbody>
                    <?php 
                        ...
                        while ($row_data = mysqli_fetch_object($data_query)) {
                            ...
                            $sum_amount += $row_data->s_total-$row_data->s_discount;
                            echo '<tr>';
                                echo "<td>".(++$no)."</td>";
                                echo "<td>$row_data->s_date</td>";
                                echo '<th class="text-center">'.number_format($row_data->s_qty,0).'</th>';
                                echo '<th class="text-center">$ '.number_format($row_data->s_discount,2).'</th>';
                                echo '<th class="text-center">$ '.number_format($row_data->s_total-$row_data->s_discount,2).'</th>';
                                echo "<td>--</td>";
                            echo '</tr>';
                        }
                    ?> 
                ...
                <tfoot>
                    ...
                    <th class="text-center">$ <?= number_format($sum_discount,2) ?></th>
