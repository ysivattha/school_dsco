        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <h3 class="text-primary">Add Student Attendance </h3>
                    ...
                    <a href="attendance_add.php?edit_id=<?php echo $v_edit_id; ?>" class="btn btn-info btn-sm"><i class="fa fa-plus"></i> Add Attendance</a>
                    <a href="attendance_copy_attendance.php?edit_id=<?php echo $v_edit_id; ?>" class="btn btn-primary btn-sm"><i class="fa fa-copy"></i> Copy Attendance</a>
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="attendance_student_check_edit.php?edit_id=<?php echo $row['att_id']; ?>&course_id=<?php echo $row['att_course_id']; ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
										<a onclick="return confirm('Are you sure to delete?');" href="attendance_student_check.php?del_id=<?php echo $row['att_id']; ?>&edit_id=<?php echo $row['att_course_id']; ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
