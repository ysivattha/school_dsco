...
$errors = ""; 
	...
	if(isset($_POST["btnadd"])){
		...
		$sql = "INSERT INTO employeetype 
		 ...
		 header('location:lsinvest.php?message=success');
		...
		<div class = "col-xs-12">
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="panel panel-default">
                        	...
                        	<div class="panel-body"><h2 class="text-primary">LS Invest</h2>
			                	<hr>
                                ...
                                <table id="example" class="display nowrap" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
											...
											{	
												$v_total_pv = $row["ls_total_pv"];		
												$v_cost_pv = $row["ls_cost_pv"];	
												$v_total_leader = $row["ls_total_leader"];	
										?>
										<tr>
											<td><?php echo $v_total_pv;?></td>
											<td><?php echo $v_cost_pv;?></td>
											<td><?php echo $v_total_leader;?></td>
											<td align = "center">
											<a href="edit_lsinvest.php?id=<?php echo $row['ls_id']; ?>" class="btn btn-primary"><i class="fa fa-edit"></i></a>
											</td>
										</tr> 
										<?php
											}	 
