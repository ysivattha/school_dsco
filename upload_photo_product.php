...
if(isset($_POST['btn_add'])){
        ...
        if($v_image["name"] != ""){
            ...
            $query_update = "UPDATE product SET
                    photo='$new_name' WHERE pro_id='$v_id'";
          ...
          <div class="row">
              ...
              <div class="panel-body">
                 <form action="" method="POST" role="form" enctype="multipart/form-data">
                  <input type="hidden" name="txt_id" value="<?= @$_GET['pro_id'] ?>">
                  <input type="hidden" name="txt_old_img" value="<?= @$_GET['pro_img'] ?>">
                 <div class="row">
                   <duv class="col-xs-6">
                    <img class="img img-thumbnail img-responsive" src="img/product/<?= @$_GET['pro_img'] ?>" alt="">
