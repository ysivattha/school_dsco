	...
	<div class="row">
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="panel panel-default">
						...
						<h3 class="text-primary">Student Active</h3>	
							<a href="student_add.php" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Add New</a>
							<a href="student_stop.php" class="btn btn-info btn-sm"><i class="fa fa-list"></i> Student Stop</a>
							<a href="student_all.php" class="btn btn-info btn-sm"><i class="fa fa-list"></i> Student All</a>
							<a href="student_print.php" class="btn btn-success btn-sm"><i class="fa fa-print"></i> Print</a>
										...
										<tr>
											...
											<td class="text-center">
												<?php
													if($v_photo == ""){
												?>
													<a href="img/student_photo/blank.png">
											...
											<td>
												<a href="student_card_id.php?sent_id=<?php echo $row['stu_id']; ?>" class="btn btn-success btn-sm"><i class="fa fa-id-card"></i> Card ID</a>
											...
											<td align="center">
												<a href="student_parent_edit.php?edit_id=<?php echo $row['stu_id']; ?>" class="btn btn-success btn-sm"><i class="fa fa-list"></i></a>
												
												<a href="student_edit.php?edit_id=<?php echo $row['stu_id']; ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
												<a onclick = "return confirm('Are you sure to delete ?');" href="student.php?del_id=<?php echo $row['stu_id']; ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
											</td>
										</tr> 
										<?php
											}	 
