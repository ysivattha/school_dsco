...
if(isset($_POST['btn_add'])){
        ...
        if($v_image["name"] != ""){
            ...
            if(file_exists("img/".$old_image) AND $old_image != 'blank.png'){
                unlink("img/".$old_image);
            }

            $new_name = date("Ymd")."_".rand(1111,9999).".png";
            move_uploaded_file($v_image["tmp_name"], "img/".$new_name);

            $query_update = "UPDATE school_info SET
                    in_banner='$new_name' WHERE in_id='$v_id'";
...
<?php include 'header.php';?>
          <div class="row">
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <hr>
                            <a href="school_info.php" class="btn btn-danger"><i class="fa fa-undo" aria-hidden="true"></i> Back</a>
              ...
              <div class="panel-body">
                 ...
                 <div class="row">
                   <duv class="col-xs-6">
                    <img class="img img-thumbnail img-responsive" src="img/<?= @$_GET['in_banner'] ?>" alt="">
