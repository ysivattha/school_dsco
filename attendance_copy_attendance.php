    ...
    <div class="col-lg-12 col-md-12">
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <a href="attendance_student_check.php?edit_id=<?php echo $_GET['edit_id']; ?>" class="btn btn-danger btn-sm"><i class="fa fa-undo"></i> Back</a>
                <a href="attendance_copy_attendance_add.php?edit_id=<?php echo $_GET['edit_id']; ?>" class="btn btn-info btn-sm"><i class="fa fa-plus"></i> Add Student</a>
                <a href="attendance_copy_attendance_sent.php?edit_id=<?php echo $_GET['edit_id']; ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Copy & Past Attendance</a>
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a onclick="return confirm('Are you sure to delete?');" href="attendance_copy_attendance.php?del_id=<?php echo $row['att_id']; ?>&sent_course_id=<?php echo $row['att_course_id']; ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
