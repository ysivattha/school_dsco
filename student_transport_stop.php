<?php include'config/db_connect.php';
	...
	if(isset($_GET["stop_id"])){
		...
		$sql = "UPDATE student_transport SET st_stop = '$v_onging'									
											WHERE st_id = '$id'" ;
		mysqli_query($connect, $sql);
		header("location:student_transport_stop.php?message=update");	
	}	
								   ...
								   <br>
                                    ...
                                    <tbody>
										...
										<tr>
											...
											<td align="center">
												<a onclick = "return confirm('Are you sure to prcessing... ?');" href="student_transport_stop.php?stop_id=<?php echo $row['st_id']; ?>" class="btn btn-success btn-sm"><i class="fa fa-check"></i> On_going</a>
											
												<a href="student_transport_edit_note.php?edit_id=<?php echo $row['st_id']; ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Note</a>
											</td>
										</tr> 
										<?php
											}	 
