<?php include'config/db_connect.php';
  ...
  if(isset($_POST["btnadd"])){
    ...
    $sql = "DELETE FROM tbl_branch WHERE bra_id = '$id'" ;
    $result = mysqli_query($connect, $sql);
            ...
            <div class = "col-xs-12">
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="panel panel-default">
                        ...
                        <h2 class="text-primary">Branch</h2>
                        <hr>
                    ...
                    <div class="col-md-12">
                        <form method="post" enctype="multipart/form-data" action="">     
                          <div class="form-group col-xs-12">
                            ...
                            <input class="form-control" required  name="txtname" type="text" placeholder="Name..">          
                          </div>
                          <div class="form-group col-xs-12">
                                    ...
                                    <tbody>
                                        ...
                                        $i=1;
                                          ...
                                          <tr>
                                            ...
                                            <td><?php echo $v3;?></td>
                                            <td align = "center">
                                            <a href="edit_branch.php?id=<?php echo $row['bra_id']; ?>" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                                            <a onclick = "return confirm('Are you sure to delete ?');" href="branch.php?id=<?php echo $row['bra_id']; ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                            </td>
                                          </tr> 
                                          <?php
                                            }  
