	...
	<div class="row">
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="panel panel-default">
						...
						<h3 class="text-primary">Student Stop</h3>	
								   ...
								   <br>
                                    ...
                                    <tbody>
										...
										<tr>
											...
											<td>
												<a href="#.php?edit_id=<?php echo $row['stu_id']; ?>" class="btn btn-default btn-sm"><i class="fa fa-dollar"></i> Pay</a>
												<a href="#.php?edit_id=<?php echo $row['stu_id']; ?>" class="btn btn-default btn-sm"><i class="fa fa-arrow-right"></i> Join Class</a>
											...
											<td align="center">
												<a href="student_parent_edit.php?edit_id=<?php echo $row['stu_id']; ?>" class="btn btn-default btn-sm"><i class="fa fa-list"></i></a>
												
												<a href="student_edit.php?edit_id=<?php echo $row['stu_id']; ?>" class="btn btn-default btn-sm"><i class="fa fa-edit"></i></a>
												<a onclick = "return confirm('Are you sure to delete ?');" href="student.php?del_id=<?php echo $row['stu_id']; ?>" class="btn btn-default btn-sm"><i class="fa fa-trash"></i></a>
											</td>
										</tr> 
										<?php
											}	 
