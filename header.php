...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      if($show['position_id'] == 1){
    ?>
      <li class="menu-item"><a href="index.php"><i class="fa fa-home" aria-hidden="true"></i><span>Home</span></a></li>
      ...
      <li class="treeview">
        <a href="#">
          ...
          <ul class="treeview-menu">
            ...
            <li class="menu-item"><a href="#.php"><i class="fa fa-file" aria-hidden="true"></i><span>Student Card </span></a></li>
            
          </ul>
      </li>
      <li class="treeview">
        <a href="#">
          <i class="fa fa-car"></i><span>Transport</span>
          <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
        </a>
      ...
      <li class="treeview">
        <a href="#">
          <i class="fa fa-circle-o"></i><span>Exam</span>
          <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
        </a>
      ...
      <li class="treeview">
        <a href="#">
          ...
          <ul class="treeview-menu">
              ...
              <li><a href="received_payment.php"><i class="fa fa-dollar" aria-hidden="true"></i><span>Received Payment
                          
              </span></a></li>
              <li><a href="alert_payment_all.php"><i class="fa fa-bell" aria-hidden="true"></i><span>Alert Payment (all)
              <span style="color:red">
                          (<?php                                          

                              $v_alert = "Alert";
                              $sql_all = "SELECT *, count(pay_id) AS countnum FROM payment AS A
                                                  LEFT JOIN student AS STU ON STU.stu_id=A.pay_student_id
                                                  LEFT JOIN course AS COU ON COU.co_id=A.pay_course_id
                                                  WHERE A.pay_stop_alert = '$v_alert'
                                                                                      ";
                              $result_all = mysqli_query($connect, $sql_all);
                              $row_all = $result_all->fetch_assoc();
                              $get_all = $row_all['countnum'];                            
                              echo $get_all;
                              
                            ?>)
                        </span>
              </span></a></li>
              <li><a href="alert_payment.php"><i class="fa fa-bell" aria-hidden="true"></i><span>Alert Payment (3days)
                        ...
                        <span style="color:red">
                          (<?php
                              ...
                              // stop alert
                              $v_stop_alert = "Stop_Alert";
                              $sql_stop = "SELECT COUNT(pay_id) AS countstop FROM payment AS A
                                                  LEFT JOIN student AS STU ON STU.stu_id=A.pay_student_id
                                                  LEFT JOIN course AS COU ON COU.co_id=A.pay_course_id
                                                  WhERE A.pay_stop_alert = '$v_stop_alert'
                                                  ";
                              $result_stop = mysqli_query($connect, $sql_stop);
                              $row_stop = $result_stop->fetch_assoc();
                              $get_stop = $row_stop['countstop'];

                              // waiting payment
                              $v_stop_alert = "Waiting_Pay";
                              $sql_wait = "SELECT COUNT(pay_id) AS countrest FROM payment AS A
                                                  LEFT JOIN student AS STU ON STU.stu_id=A.pay_student_id
                                                  LEFT JOIN course AS COU ON COU.co_id=A.pay_course_id
                                                  WhERE A.pay_stop_alert = '$v_stop_alert'
                                                                                      ";
                              $result_wait = mysqli_query($connect, $sql_wait);
                              $row_wait = $result_wait->fetch_assoc();
                              $get_wait = $row_wait['countrest'];

                              //

                              $get_alert = $get_count-$get_stop-$get_wait;
                              echo $get_alert;
              ...
              <li><a href="stop_alert_payment.php"><i class="fa fa-times" aria-hidden="true"></i><span>Stop Alert List
                        <span style="color:red">
                          (<?php                        
                              echo $get_stop;
                            ?>)
              ...
              <li><a href="payment.php"><i class="fa fa-cube" aria-hidden="true"></i><span>Payment History
                        <span style="color:red">
                          (<?php
                              $sql_count = "SELECT *, COUNT(pay_id) AS countnum
                                                FROM payment AS A
                                                LEFT JOIN student AS STU ON STU.stu_id=A.pay_student_id
                                                LEFT JOIN course AS COU ON COU.co_id=A.pay_course_id
      ...
      <li class="treeview">
        <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="#.php"><i class="fa fa-check" aria-hidden="true"></i><span>Attendance Teacher</span></a></li>
            <li><a href="attendance.php"><i class="fa fa-check" aria-hidden="true"></i><span>Attendance Student</span></a></li>
            <li><a href="attendance_report.php"><i class="fa fa-file" aria-hidden="true"></i><span>Attend Student Report</span></a></li>
      ...
      <li class="treeview">
        <a href="#">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="stock_in.php"><i class="fa fa-arrow-down" aria-hidden="true"></i><span> Stock In</span></a></li>
            <li><a href="stock_out.php"><i class="fa fa-arrow-right" aria-hidden="true"></i><span> Stock Out</span></a></li>
            <li><a href="stock_balance.php"><i class="fa fa-arrows-h" aria-hidden="true"></i><span> Stock Balance</span></a></li>
      ...
      <li class="treeview">
        <a href="#">
          <i class="fa fa-book"></i><span>Subject & Course</span>
          <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
        </a>
          <ul class="treeview-menu">
            ...
            <li><a href="course.php"><i class="fa fa-pencil" aria-hidden="true"></i><span>Subject</span></a></li>
            <li><a href="course_all.php"><i class="fa fa-list" aria-hidden="true"></i><span>All Class</span></a></li>
            <li><a href="class.php"><i class="fa fa-book" aria-hidden="true"></i><span>Class on Going</span></a></li>
            <li><a href="course_finish.php"><i class="fa fa-arrow-left" aria-hidden="true"></i><span>Class Finish</span></a></li>
      ...
      <li class="treeview">
        <a href="#">
          <i class="fa fa-dollar"></i><span>Finance & Account</span>
          <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
        </a>
      ...
      <li class="treeview">
        <a href="#">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="#.php"><i class="fa fa-user-circle-o" aria-hidden="true"></i><span>Permission</span></a></li>
            ...
            <li><a href="school_info.php"><i class="fa fa-home" aria-hidden="true"></i><span> School Info</span></a></li>
    ...
    ?>
      <li><a href="dashboard_teacher.php"><i class="fa fa-dashboard" aria-hidden="true"></i><span>Dashboard</span></a></li>
