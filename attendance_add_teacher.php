...
$user_id = $_SESSION['user_id'];
	...
	if(isset($_POST["btnadd"])){
		...
		$sql = "INSERT INTO attendance (att_course_id
								, att_student_id
								, att_date
								, att_yes
								, att_a
      ...
      <div class="row">
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                	<div class="panel-body"><h2 class="text-primary">Add Attendance</h2>
                		<hr>
                	</div>
							...
							<form method="post" enctype="multipart/form-data" action="">         
								...
								<div class="form-group col-xs-12">
									<label for ="">Attendance Type:</label>                                          
										<select class = "form-control select2" style = "width:100%" name="txt_attendance_type">
											<option value="">==== Choose ====</option>
												<?php
												$v_select = mysqli_query($connect,"SELECT * FROM text_attendance");
												while ($row1 = mysqli_fetch_assoc($v_select)) { ?>
												<option value="<?php echo $row1['ta_name']; ?>"><?php echo $row1['ta_name'] ;?> </option>
												<?php 
												}
												?>   
										</select>           
								...
								<div class="form-group col-xs-12">
									...
									<a href="attendance_student_check_teacher.php?edit_id=<?php echo $id; ?>" class="btn btn-danger btn-sm"><i class="fa fa-undo"></i> Back</a>
								</div> 
							</form>
						</div>
					</div>
