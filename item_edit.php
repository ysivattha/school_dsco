<?php
	...
	if(!empty($_POST["id"])){
			...
			$sql = "UPDATE payment_detail SET payd_payment_id = '$main_id'
									, payd_item_id = '$v_item'
									, payd_qty = '$v_qty'
									, payd_price = '$v_price'
						...
						<div class="col-md-6">
							...
							<input type = "hidden" name = "id" value = "<?php echo $id; ?>"> 
								...
								<div class="form-group col-xs-12">
									...
									<a href="received_payment_detail.php?edit_id=<?php echo $main_id ?>" class="btn btn-danger btn-sm"><i class="fa fa-undo"></i> Back</a>
								</div> 
							</form>
						</div>
					</div>
