		...
		<div class = "col-xs-12">
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="panel panel-default">
                        	...
                        	<div class="panel-body"><h2 class="text-primary">Employee Type</h2>
			                	<hr>
                                ...
                                <table id="example" class="display nowrap" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
										...
										<tr>
											...
											<td align = "center">
											<a href="edit_employeetype.php?id=<?php echo $row['etid']; ?>" class="btn btn-primary"><i class="fa fa-edit"></i></a>
											<a onclick = "return confirm('Are you sure to delete ?');" href="employeetype.php?id=<?php echo $row['etid']; ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
											</td>
										</tr> 
										<?php
											}	 
