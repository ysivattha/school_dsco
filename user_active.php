<?php include'config/db_connect.php';
  ...
  $sql = "SELECT * FROM tbl_user_active";  
  ...
  if(isset($_POST["btnadd"])){
    ...
    $v_note = $_POST["txt_note"];
     ...
     $sql = "INSERT INTO tbl_user_active 
                        (ua_name
                          , ua_note) 
              VALUES 
                    ('$v_name'
     ...
     header('location:user_active.php?message=success');
 }
    if(isset($_GET["id"])){
    $id = $_GET["id"];
      
    $sql = "DELETE FROM tbl_user_active WHERE ua_id = '$id'" ;
    $result = mysqli_query($connect, $sql);
    header("location:user_active.php?message=delete");  
} 
?>
            ...
            <div class = "col-xs-12">
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="panel panel-default">
                        ...
                        <h2 class="text-primary">User Active</h2>
                        <hr>
                        <!--
                                    ...
                                    <tbody>
                                        <?php
                                          ...
                                          <tr>
                                            ...
                                            <td> </td>
                                            <td align = "center">
                                            <a href="edit_user_active.php?id=<?php echo $row['ua_id']; ?>" class="btn btn-primary"><i class="fa fa-edit"></i></a>
