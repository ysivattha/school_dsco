                    ...
                    <table id="example" class="display nowrap" width="100%" cellspacing="0">
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="course_add_student_teacher.php?edit_id=<?php echo $row['co_id']; ?>" class="btn btn-primary btn-sm"><i class="fa fa-users"></i> Students
                                            <?php
                                                $v_course_id =$row['co_id'];
                                        ...
                                        <a href="course_teacher_edit_teacher.php?edit_id=<?php echo $row['co_id']; ?>" class="btn btn-info btn-sm"><i class="fa fa-user"></i> Teacher</a>
